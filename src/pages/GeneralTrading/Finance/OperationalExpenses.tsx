...
const OperationalExpenses = () => {
  ...
  const loadData = async () => {
    try {
      setLoading(true);
      const data = await storageService.get<OperationalExpense[]>('gt_operationalExpenses') || [];
  ...
  const handleSave = async () => {
    try {
      ...
      if (editingExpense) {
        ...
        await storageService.set(StorageKeys.GENERAL_TRADING.OPERATIONAL_EXPENSES, updated);
