...
const Workflow = () => {
  ...
  // Define nodes dengan posisi dan connections (compact untuk 1 screen)
  const nodes: WorkflowNode[] = [
    {
      id: 'so',
      name: 'Sales Orders',
      module: 'Sales Orders',
      path: '/packaging/sales-orders',
      icon: '📋',
      x: 80,
      y: 80,
      type: 'start',
      connections: ['ppic', 'quotation'],
    },
    {
      id: 'quotation',
      name: 'Quotation',
      module: 'Tab Quotation',
      path: '/packaging/sales-orders',
      icon: '📄',
      x: 80,
      y: 180,
    ...
    },
    {
      ...
      y: 80,
      type: 'process',
      connections: ['purchasing'],
    },
    {
      id: 'ptp',
      name: 'PTP',
      module: 'Permintaan Tanpa PO',
      path: '/packaging/ppic',
      icon: '📝',
      x: 220,
      y: 180,
    ...
    },
    {
      ...
      path: '/packaging/master/inventory',
      icon: '📊',
      x: 500,
      y: 180,
      type: 'process',
    ...
    },
    {
      ...
      path: '/packaging/finance/invoices',
      icon: '🧾',
      x: 1060,
      y: 80,
      type: 'finance',
    ...
    },
    {
      ...
      name: 'Payment',
      module: 'Payments',
      path: '/packaging/finance/payments',
      icon: '💳',
      x: 920,
      y: 280,
      type: 'end',
  ...
  return (
    <div className="module-compact">
      <div className="page-header">
        <h1>Packaging Workflow</h1>
        <p className="page-subtitle">Visual workflow alur kerja packaging - Klik node untuk navigasi</p>
      </div>
      ...
      <Card>
        ...
        <div className="workflow-description">
          <h3 style={{ marginBottom: '8px', fontSize: '12px', fontWeight: '600' }}>Alur Kerja:</h3>
          <ol style={{ margin: 0, paddingLeft: '18px', fontSize: '11px', lineHeight: '1.6', color: 'var(--text-secondary)' }}>
            ...
            <li><strong>PPIC</strong> → Create SPK dari SO approved, atau dari PTP (Permintaan Tanpa PO)</li>
            <li><strong>Purchasing</strong> → Create PO untuk material dari SPK</li>
            <li><strong>GRN</strong> → Goods Receipt Note saat material diterima, update Inventory</li>
            <li><strong>Production</strong> → Submit hasil produksi dari SPK</li>
            <li><strong>QA/QC</strong> → Quality check production results (PASS/FAIL)</li>
            <li><strong>WH/Delivery</strong> → Create Delivery Note dari QC PASS</li>
            <li><strong>Invoice</strong> → Create Customer Invoice dari Delivery</li>
            <li><strong>AR</strong> → Accounts Receivable tracking</li>
            <li><strong>AP</strong> → Accounts Payable untuk supplier payment</li>
