...
console.log('🔄 Merging Trucking data (Invoices, Delivery Orders, Surat Jalan)...\n');

// Define file pairs to merge
const filePairs = [
  {
    name: 'Trucking Invoices',
    file1: 'master/trucking/trucking_invoices.json',
    file2: 'master/packaging/trucking_invoices.json',
    key: 'invoiceNo',
    normalize: true
  },
  {
    name: 'Trucking Delivery Orders',
    file1: 'master/trucking/trucking_delivery_orders.json',
    file2: 'master/packaging/trucking_deliveryOrders.json',
    key: 'doNo'
  },
  {
    name: 'Trucking Surat Jalan',
    file1: 'master/trucking/trucking_suratJalan.json',
    file2: 'master/packaging/trucking_suratJalan.json',
    key: 'sjNo'
  }
];
